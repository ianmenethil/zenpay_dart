...
- **[lib/AGENTS.md](file:///g:/_zp-repos/zp-flutter-sdk/backend/lib/AGENTS.md)** — Core `zenpay_dart` package architecture (callback verifiers, tokens, URL builders, crypto, enums).
- **[example/AGENTS.md](file:///g:/_zp-repos/zp-flutter-sdk/backend/example/AGENTS.md)** — Reference Shelf backend architecture (attempt store, config, rate limiting, routing, session service).
